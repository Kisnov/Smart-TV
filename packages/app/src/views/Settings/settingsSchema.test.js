...
const CUSTOM_RENDERERS = ['moonfinStatus', 'seerrPanel', 'aboutDataActions', 'imageCacheActions', 'checkForUpdates', 'profileSync', 'playbackTimePreview', 'screensaverPreview', 'loadingAnimationPreview'];
